...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new Callback() {
            ...
            // 往RecyclerView的某个位置上插入一个view
            public void addView(View child, int index) {
                RecyclerView.this.addView(child, index);
                RecyclerView.this.dispatchChildAttached(child);
            }
            // view在RecyclerView的哪个位置
            public int indexOfChild(View view) {
                return RecyclerView.this.indexOfChild(view);
            }
            // 把RecyclerView的某个位置上的view移除掉
    ...
    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new android.support.v7.widget.AdapterHelper.Callback() {
            ...
            public void offsetPositionsForRemovingInvisible(int start, int count) {
                ...
                RecyclerView.State var10000 = RecyclerView.this.mState;
                var10000.mDeletedInvisibleItemCountSincePreviousLayout += count;
            }
    ...
    private void requestChildOnScreen(@NonNull View child, @Nullable View focused) {
        ...
        if (focusedLayoutParams instanceof RecyclerView.LayoutParams) {
            ...
            if (!lp.mInsetsDirty) {
                ...
                Rect var10000 = this.mTempRect;
                var10000.left -= insets.left;
                var10000 = this.mTempRect;
                var10000.right += insets.right;
                var10000 = this.mTempRect;
                var10000.top -= insets.top;
                var10000 = this.mTempRect;
                var10000.bottom += insets.bottom;
            }
        }
    ...
    public abstract static class ItemAnimator {
        ...
        private ArrayList<RecyclerView.ItemAnimator.ItemAnimatorFinishedListener>
    ...
    public static class State {
        ...
        public <T> T get(int resourceId) {
            return this.mData == null ? null : (T)this.mData.get(resourceId);
        }
    ...
    public abstract static class SmoothScroller {
        ...
        private final RecyclerView.SmoothScroller.Action mRecyclingAction =
                new RecyclerView.SmoothScroller.Action(0, 0);
        ...
        // 通过调用LinearLayoutManager类中的相应方法触发这里的
    ...
    public abstract static class LayoutManager {
        ...
        ChildHelper mChildHelper;
        private final android.support.v7.widget.ViewBoundsCheck.Callback
        ...
        void setRecyclerView(RecyclerView recyclerView) {
            if (recyclerView == null) {
                ...
                // 刚开始时都为0
                MLog.d(TAG, "LayoutManager setRecyclerView() mWidth: " + mWidth +
                        " mHeight: " + mHeight);
            }
        ...
        void setMeasureSpecs(int wSpec, int hSpec) {
            ...
            MLog.d(TAG, "LayoutManager setMeasureSpecs() mWidth: " + mWidth +
                    " mHeight: " + mHeight);
        }
        ...
        public void startSmoothScroll(RecyclerView.SmoothScroller smoothScroller) {
            if (this.mSmoothScroller != null
                    ...
                    && this.mSmoothScroller.isRunning()) {
