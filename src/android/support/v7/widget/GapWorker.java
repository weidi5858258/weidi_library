...
final class GapWorker implements Runnable {
    ...
    static Comparator<GapWorker.Task> sTaskComparator = new Comparator<GapWorker.Task>() {
    ...
    static boolean isPrefetchPositionAttached(RecyclerView view, int position) {
        ...
        for(int i = 0; i < childCount; ++i) {
            ...
            ViewHolder holder = RecyclerView.getChildViewHolderInt(attachedView);
    ...
    private void flushTaskWithDeadline(GapWorker.Task task, long deadlineNs) {
        ...
        ViewHolder holder = this.prefetchPositionWithDeadline(task.view, task.position, taskDeadlineNs);
