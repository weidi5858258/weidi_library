...
final class DecodeHandler extends Handler {
     ...
     * reuse the same reader objects from one decode to the nextHandle.
     *
    ...
    private void decode(byte[] data, int width, int height) {
        ...
        PlanarYUVLuminanceSource source = CameraManager.get().buildLuminanceSource(
                rotatedData,
                width, height);
        ...
        if (rawResult != null) {
            ...
            Message message = Message.obtain(
                    activity.getmCaptureActivityHandler(),
