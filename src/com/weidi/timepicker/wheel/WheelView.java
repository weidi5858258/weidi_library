...
package com.weidi.timepicker.wheel;
...
import com.weidi.timepicker.adapters.WheelViewAdapter;
import com.weidi.timepicker.config.DefaultConfig;
...
public class WheelView extends View {
    ...
    // Listeners
    private List<OnWheelChangedListener> changingListeners = new
            LinkedList<OnWheelChangedListener>();
    private List<OnWheelScrollListener> scrollingListeners = new
    ...
    private List<OnWheelClickedListener> clickingListeners = new
            LinkedList<OnWheelClickedListener>();
    // Adapter listener
    ...
    private void initData(Context context) {
        ...
        //        mPaintLineRight.setStrokeWidth(context.getResources().getDimensionPixelSize(R
        // .dimen.picker_line_width));
        ...
        mLineRightMar = context.getResources().getDimensionPixelSize(com.weidi.library.R.dimen.picker_line_mar);
    ...
    private int calculateLayoutWidth(int widthSize, int mode) {
        ...
        // TODO: make it static
        itemsLayout.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams
                .WRAP_CONTENT));
    ...
    private boolean rebuildItems() {
        ...
        if (!updated) {
            updated = firstItem != range.getFirst() || itemsLayout.getChildCount() != range
                    .getCount();
        }
