...
import com.weidi.timepicker.adapters.NumericWheelAdapter;
import com.weidi.timepicker.config.PickerConfig;
import com.weidi.timepicker.data.source.TimeRepository;
import com.weidi.timepicker.utils.PickerContants;
import com.weidi.timepicker.utils.Utils;
import com.weidi.timepicker.wheel.OnWheelChangedListener;
import com.weidi.timepicker.wheel.WheelView;
...
public class TimeWheel {
    ...
    NumericWheelAdapter mYearAdapter, mMonthAdapter, mDayAdapter,
            mHourAdapter, mMinuteAdapter, mSecondAdapter;

    PickerConfig mPickerConfig;
    TimeRepository mRepository;
    private OnWheelChangedListener yearListener = new OnWheelChangedListener() {
        @Override
        public void onChanged(WheelView wheel, int oldValue, int newValue) {
            updateMonths();
        }
    };
    private OnWheelChangedListener monthListener = new OnWheelChangedListener() {
        @Override
        public void onChanged(WheelView wheel, int oldValue, int newValue) {
            updateDays();
        }
    ...
    private OnWheelChangedListener minuteListener = new OnWheelChangedListener() {
        @Override
        public void onChanged(WheelView wheel, int oldValue, int newValue) {
            updateMinutes();
        }
    ...
    void initYear() {
        ...
        mYearAdapter = new NumericWheelAdapter(mContext, minYear, maxYear, PickerContants.FORMAT,
                mPickerConfig.mYear);
    ...
    void updateMonths() {
        ...
        mMonthAdapter = new NumericWheelAdapter(mContext, minMonth, maxMonth, PickerContants
                .FORMAT, mPickerConfig.mMonth);
    ...
    void updateDays() {
        ...
        int minDay = mRepository.getMinDay(curYear, curMonth);
        mDayAdapter = new NumericWheelAdapter(mContext, minDay, maxDay, PickerContants.FORMAT,
                mPickerConfig.mDay);
    ...
    void updateHours() {
        ...
        mHourAdapter = new NumericWheelAdapter(mContext, minHour, maxHour, PickerContants.FORMAT,
                mPickerConfig.mHour);
    ...
    void updateMinutes() {
        ...
        mMinuteAdapter = new NumericWheelAdapter(mContext, minMinute, maxMinute, PickerContants
                .FORMAT, mPickerConfig.mMinute);
    ...
    public int getCurrentMinute() {
        ...
        return minute.getCurrentItem() + mRepository.getMinMinute(curYear, curMonth, curDay,
                curHour);
    }
