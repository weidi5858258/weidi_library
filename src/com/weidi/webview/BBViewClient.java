...
public class BBViewClient extends WebChromeClient {
    ...
    public void onProgressChanged(WebView view, int newProgress) {
        ...
        if (newProgress <= 25) {
            ...
            if (view instanceof BBWebView) {
                BBWebView bbWebView = (BBWebView) view;
                bbWebView.injectJavascriptInterfaces();
            }
    ...
    public boolean onJsPrompt(WebView view, String url, String message,
        ...
        if (view instanceof BBWebView) {
            BBWebView bbWebView = (BBWebView) view;
            if (bbWebView.handleJsInterface(view, url, message, defaultValue,
                    result)) {
                return true;
            }
        }
