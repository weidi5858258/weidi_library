 ...
 * 自定义WebViewClient实现类
 * @author songdiyuan
 * @version $Id: BBWebCoreClient.java, v 1.0.0 2015-8-18 下午4:57:27 xl Exp $
 */
public class BBWebCoreClient extends WebViewClient {
	...
	public boolean shouldOverrideUrlLoading(WebView view, String url) {
		//地址过滤
		LogCatLog.d(TAG, " getHost: " + Uri.parse(url).getHost());
		LogCatLog.d(TAG, " getScheme: " + Uri.parse(url).getScheme());
		LogCatLog.d(TAG, " getPath: " + Uri.parse(url).getPath());
